...
if __name__ == "__main__":
    ...
    # print("Producing embeddings for pre-180 timeframe using fine-tuned model...")
    # berts_finetuned_pre_180 = calculate_embeddings(
    #     time2corpus["pre_180"],
    #     latin_bert_finetuned,
    #     "berts_finetuned_pre_180.h5",
    #     stopwords=stopwords,
    # )
    # print("Embeddings for pre-180 timeframe using fine-tuned model completed.\n")

    # Extract embeddings for post-180 timeframe and save
    print("Producing embeddings for post-180 timeframe using fine-tuned model...")
    berts_finetuned_post_180 = calculate_embeddings(
        time2corpus["post_180"],
        latin_bert_finetuned,
        "berts_finetuned_post_180.h5",
        stopwords=stopwords,
    )
    print("Embeddings for post-180 timeframe using fine-tuned model completed.\n")

    # # Extract embeddings for the 20-text sample and save
    # print("Producing embeddings for the 20-text sample using fine-tuned model...")
    # berts_finetuned_sample_20 = calculate_embeddings(
    #     corpus_texts,
    #     latin_bert_finetuned,
    #     "berts_finetuned_sample_20.h5",
    #     stopwords=stopwords,
    # )
    # print("Embeddings for the 20-text sample using fine-tuned model completed.\n")
