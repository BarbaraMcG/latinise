...
def calculate_embeddings(corpus, dir_out, output_filename, tokenizer_path, bert_path, max_seq_length=512):
...
# Extract embeddings for first timeframe and save# Extract embeddings for first timeframe and save
print("Producing embeddings for the first timeframe...")
bert_sents_t0 = calculate_embeddings(time2corpus[0], dir_out, "bert_t0_results.pickle", tokenizer_path, bert_path)
...
bert_sents_t1 = calculate_embeddings(time2corpus[1], dir_out, "bert_t1_results.pickle", tokenizer_path, bert_path)
...
bert_sents_christi = calculate_embeddings(corpus_christi, dir_out, "bert_christi_results.pickle", tokenizer_path, bert_path)
...
bert_sents_non_christi = calculate_embeddings(corpus_non_christi, dir_out, "bert_non_christi_results.pickle", tokenizer_path, bert_path)
